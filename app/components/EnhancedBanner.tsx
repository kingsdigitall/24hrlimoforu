...
export default function EnhancedBanner({ 
  ...
  return (
    ...
    >
      ...
      <Image
        src="https://ik.imagekit.io/h7rza8886p/24%20hour%20Limo%20Rental/Black%20Chrysler%20Limousine%20Up%20To%208%20Adults1.jpg?updatedAt=1755857560313"
        alt="Luxury Limo Car"
        fill
      ...
      {/* Main Content: Glass card and optional carousel */}
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between w-full max-w-6xl mx-auto px-4 py-16 gap-10 animate-fade-in">
        ...
        <div className="flex-1 flex flex-col items-start justify-center w-full max-w-lg backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-10 md:mr-4 relative">
          ...
          <p className="text-lg sm:text-2xl mb-10 font-medium text-white/90 drop-shadow">
            {description || "Luxury Ride | Premium Vehicles | Affordable Pricing | Experienced Drivers | On-time Service"}
            <br className="hidden sm:inline" /> Book your ride today!
          </p>
